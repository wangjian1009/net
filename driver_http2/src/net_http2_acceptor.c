...
int net_http2_acceptor_on_new_endpoint(void * ctx, net_endpoint_t base_control) {
    ...
    /*         net_endpoint_dump(net_http2_driver_tmp_buffer(driver), base_control)); */
    /*     goto INIT_ERROR; */
    /* } */
    /* stream = net_http2_endpoint_cast(base_endpoint); */
    /* assert(stream); */
...
int net_http2_acceptor_init(net_acceptor_t base_acceptor) {
    net_http2_driver_t driver = net_driver_data(net_acceptor_driver(base_acceptor));
    net_http2_acceptor_t acceptor = net_acceptor_data(base_acceptor);
    ...
    /*         net_http2_acceptor_on_new_endpoint, base_acceptor); */
...
void net_http2_acceptor_fini(net_acceptor_t base_acceptor) {
    net_http2_acceptor_t acceptor = net_acceptor_data(base_acceptor);
    net_http2_driver_t driver = net_driver_data(net_acceptor_driver(base_acceptor));
