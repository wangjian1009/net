...
int net_http2_endpoint_create_underline(net_endpoint_t base_endpoint);
void net_http2_endpoint_update_readable(net_endpoint_t base_endpoint);

int net_http2_endpoint_init(net_endpoint_t base_endpoint) {
    net_http2_endpoint_t endpoint = net_endpoint_data(base_endpoint);
...
int net_http2_endpoint_connect(net_endpoint_t base_endpoint) {
    net_schedule_t schedule = net_endpoint_schedule(base_endpoint);
    net_http2_driver_t driver = net_driver_data(net_endpoint_driver(base_endpoint));
    net_http2_endpoint_t endpoint = net_endpoint_data(base_endpoint);

    /* if (net_http2_endpoint_set_runing_mode(endpoint->m_underline, net_http2_endpoint_runing_mode_cli) != 0) { */
    /*     CPE_ERROR( */
...
int net_http2_endpoint_update(net_endpoint_t base_endpoint) {
    net_schedule_t schedule = net_endpoint_schedule(base_endpoint);
    net_http2_driver_t driver = net_driver_data(net_endpoint_driver(base_endpoint));
    net_http2_endpoint_t endpoint = net_endpoint_data(base_endpoint);
    ...
    /*                 net_endpoint_dump(net_http2_driver_tmp_buffer(driver), base_endpoint), buf_size); */
    /*             return -1; */
    /*         } */

    /*         if (net_endpoint_driver_debug(base_endpoint) >= 2) { */
    /*             char name_buf[128]; */
    /*             cpe_str_dup(name_buf, sizeof(name_buf), net_endpoint_dump(net_http2_driver_tmp_buffer(driver), base_endpoint)); */
    /*             CPE_INFO( */
    /*                 driver->m_em, "ws: stream: %s: ==> %d data\n%s", */
    /*                 name_buf, buf_size, */
    /*                 mem_buffer_dump_data(net_http2_driver_tmp_buffer(driver), buf, buf_size, 0)); */
    /*         } */
            
    /*         if (net_http2_endpoint_send_msg_bin(endpoint->m_underline, buf, buf_size) != 0) { */
    /*             CPE_ERROR( */
...
int net_http2_endpoint_set_no_delay(net_endpoint_t base_endpoint, uint8_t no_delay) {
    net_http2_driver_t driver = net_driver_data(net_endpoint_driver(base_endpoint));
    net_http2_endpoint_t endpoint = net_endpoint_data(base_endpoint);
...
int net_http2_endpoint_get_mss(net_endpoint_t base_endpoint, uint32_t * mss) {
    net_http2_driver_t driver = net_driver_data(net_endpoint_driver(base_endpoint));
    net_http2_endpoint_t endpoint = net_endpoint_data(base_endpoint);
...
net_http2_endpoint_create(net_http2_driver_t driver, net_protocol_t protocol) {
...
net_http2_endpoint_cast(net_endpoint_t base_endpoint) {
    ...
    return net_driver_endpoint_init_fun(driver) == net_http2_endpoint_init
        ? net_endpoint_data(base_endpoint)
        : NULL;
}

net_http2_control_endpoint_t
net_http2_endpoint_control(net_http2_endpoint_t endpoint) {
    return endpoint->m_control;
}

net_endpoint_t
net_http2_endpoint_base_endpoint(net_http2_endpoint_t endpoint) {
