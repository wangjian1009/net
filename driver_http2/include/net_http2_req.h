...
int net_http2_req_start_request(net_http2_req_t http_req, uint8_t have_follow_data);
int net_http2_req_start_response(net_http2_req_t http_req, uint8_t have_follow_data);
