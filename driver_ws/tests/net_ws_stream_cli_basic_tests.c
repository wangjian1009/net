...
static void net_ws_stream_cli_underline_connecting(void **state) {
    net_ws_testenv_t env = *state;
    net_endpoint_t stream_endpoint = net_ws_testenv_stream_ep_create(env);
    net_endpoint_t underline = net_ws_stream_endpoint_underline(stream_endpoint);
...
static void net_ws_connect_success(void **state) {
    net_ws_testenv_t env = *state;
    net_endpoint_t ep = net_ws_testenv_stream_ep_create(env);
    ...
    net_endpoint_t underline = net_ws_stream_endpoint_underline(ep);
