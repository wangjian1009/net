#ifndef TEST_NET_WS_STREAM_PAIR_TESTENV_H_INCLEDED
#define TEST_NET_WS_STREAM_PAIR_TESTENV_H_INCLEDED
#include "net_acceptor.h"
#include "net_ws_testenv.h"

typedef struct net_ws_stream_pair_testenv * net_ws_stream_pair_testenv_t;

struct net_ws_stream_pair_testenv {
