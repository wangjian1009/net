...
static void net_ws_cli_undline_connecting(void **state) {
    net_ws_testenv_t env = *state;
    net_endpoint_t ws_endpoint = net_ws_testenv_cli_ep_create(env);
    net_endpoint_t underline = net_ws_cli_endpoint_underline(ws_endpoint);
...
static void net_ws_cli_undline_established(void **state) {
    net_ws_testenv_t env = *state;
    net_endpoint_t ws_endpoint = net_ws_testenv_cli_ep_create(env);
    net_endpoint_t underline = net_ws_cli_endpoint_underline(ws_endpoint);
...
static void net_ws_cli_connect_success(void **state) {
    net_ws_testenv_t env = *state;
    net_endpoint_t ep = net_ws_testenv_cli_ep_create(env);
    ...
    net_endpoint_t underline = net_ws_cli_endpoint_underline(ep);
...
int net_ws_cli_basic_tests() {
	const struct CMUnitTest ws_basic_tests[] = {
		cmocka_unit_test_setup_teardown(net_ws_cli_undline_connecting, setup, teardown),
		cmocka_unit_test_setup_teardown(net_ws_cli_undline_established, setup, teardown),
