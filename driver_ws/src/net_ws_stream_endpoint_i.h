#ifndef NET_WS_STREAM_ENDPOINT_I_H_INCLEDED
#define NET_WS_STREAM_ENDPOINT_I_H_INCLEDED
...
int net_ws_stream_endpoint_get_mss(net_endpoint_t endpoint, uint32_t * mss);
