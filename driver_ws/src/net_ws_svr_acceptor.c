...
int net_ws_svr_acceptor_on_new_endpoint(void * ctx, net_endpoint_t base_underline) {
    ...
    assert(underline->m_ws_endpoint == NULL);
    ...
    net_ws_svr_endpoint_t new_endpoint = net_endpoint_data(new_base_endpoint);
    new_endpoint->m_underline = base_underline;
    underline->m_ws_endpoint = new_endpoint;
...
int net_ws_svr_acceptor_init(net_acceptor_t base_acceptor) {
    struct net_ws_svr_acceptor * acceptor = net_acceptor_data(base_acceptor);
    net_ws_svr_driver_t driver = net_driver_data(net_acceptor_driver(base_acceptor));
    ...
    acceptor->m_underline =
        net_acceptor_create(
            ...
            net_ws_svr_acceptor_on_new_endpoint,
            base_acceptor);
...
void net_ws_svr_acceptor_fini(net_acceptor_t base_acceptor) {
    struct net_ws_svr_acceptor * acceptor = net_acceptor_data(base_acceptor);
