#ifndef NET_WS_SVR_PROTOCOL_H_INCLEDED
#define NET_WS_SVR_PROTOCOL_H_INCLEDED
...
net_ws_svr_protocol_t
net_ws_svr_protocol_find(net_schedule_t schedule, const char * name);

net_ws_svr_protocol_t net_ws_svr_protocol_cast(net_protocol_t protocol);
