...
int net_ssl_svr_underline_init(net_endpoint_t base_endpoint) {
    return 0;
}

void net_ssl_svr_underline_fini(net_endpoint_t base_endpoint) {
}

int net_ssl_svr_underline_input(net_endpoint_t base_endpoint) {
    return 0;
}

int net_ssl_svr_underline_on_state_change(net_endpoint_t base_endpoint, net_endpoint_state_t from_state) {
    return 0;
}
