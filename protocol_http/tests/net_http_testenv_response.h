#ifndef TESTS_NET_PROTOCOL_HTTP_TESTENV_RESPONSE_H_INCLEDED
#define TESTS_NET_PROTOCOL_HTTP_TESTENV_RESPONSE_H_INCLEDED
#include "cpe/utils/buffer.h"
#include "net_http_testenv.h"
#include "net_http_req.h"

struct net_http_testenv_response {
    net_http_testenv_t m_env;
    TAILQ_ENTRY(net_http_testenv_response) m_next;
    uint32_t m_req_id;
