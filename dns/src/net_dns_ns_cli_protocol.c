...
static int net_dns_ns_cli_protocol_init(net_protocol_t protocol);
static void net_dns_ns_cli_protocol_fini(net_protocol_t protocol);
...
net_dns_ns_cli_protocol_t net_dns_ns_cli_protocol_create(net_dns_manage_t manage) {
    net_protocol_t protocol =
        net_protocol_create(
            ...
            "dns-cli",
            /*protocol*/
            sizeof(struct net_dns_ns_cli_protocol),
            net_dns_ns_cli_protocol_init,
            net_dns_ns_cli_protocol_fini,
            /*endpoint*/
            sizeof(struct net_dns_ns_cli_endpoint),
            net_dns_ns_cli_endpoint_init,
            net_dns_ns_cli_endpoint_fini,
            net_dns_ns_cli_endpoint_input,
            net_dns_ns_cli_endpoint_forward,
            NULL/*direct*/,
    ...
    net_dns_ns_cli_protocol_t dns_protocol = net_protocol_data(protocol);
