...
typedef struct prometheus_process_limits_testenv * prometheus_process_limits_testenv_t;

struct prometheus_process_limits_testenv {
    prometheus_process_testenv_t m_env;
    uint32_t m_row_count;
    struct prometheus_process_limits_row m_rows[100];
};

prometheus_process_limits_testenv_t prometheus_process_limits_testenv_create();
