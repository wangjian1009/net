...
void test_net_acceptor_expect_next_init_success();

int test_net_acceptor_accept(
    net_acceptor_t base_acceptor, net_endpoint_t remote_ep, int64_t write_delay_ms);
