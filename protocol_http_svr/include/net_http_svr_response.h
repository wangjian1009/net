#ifndef NET_HTTP_SVR_RESPONSE_H
#define NET_HTTP_SVR_RESPONSE_H
#include "cpe/utils/utils_types.h"
#include "net_http_svr_system.h"

NET_BEGIN_DECL

enum net_http_svr_response_state {
    net_http_svr_response_state_init,
    net_http_svr_response_state_head,
    net_http_svr_response_state_body,
    net_http_svr_response_state_done,
};

net_http_svr_response_t net_http_svr_response_create(net_http_svr_request_t request);
...
net_http_svr_request_transfer_encoding_t net_http_svr_response_transfer_encoding(net_http_svr_response_t response);
net_http_svr_response_state_t net_http_svr_response_state(net_http_svr_response_t response);
