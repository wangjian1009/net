...
net_http_svr_mount_point_t net_http_svr_mount_point_mount(net_http_svr_mount_point_t from, const char * path, void * backend_env, net_http_svr_processor_t backend);
...
net_http_svr_mount_point_t net_http_svr_mount_point_find_child_by_path(net_http_svr_mount_point_t mount_point, const char * * path);
