#ifndef NET_HTTP_SVR_RESPONSE_H_I_INCLEDED
#define NET_HTTP_SVR_RESPONSE_H_I_INCLEDED
#include "net_http_svr_response.h"
#include "net_http_svr_request_i.h"

struct net_http_svr_response {
    net_http_svr_request_t m_request;
    union {
        TAILQ_ENTRY(net_http_svr_response) m_next;
        struct {
            net_http_svr_response_state_t m_state;
