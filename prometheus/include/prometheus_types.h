...
typedef struct prometheus_metric_sample_histogram * prometheus_metric_sample_histogram_t;
...
typedef struct prometheus_histogram_buckets * prometheus_histogram_buckets_t;
