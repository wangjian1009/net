...
typedef int (*net_ws_endpoint_on_state_change_fun_t)(net_ws_endpoint_t ws_ep, net_ws_state_t from_state);
typedef int (*net_ws_endpoint_on_text_msg_fun_t)(net_ws_endpoint_t ws_ep, const char * data);
typedef int (*net_ws_endpoint_on_bin_msg_fun_t)(net_ws_endpoint_t ws_ep, void const * data, size_t data_len);
