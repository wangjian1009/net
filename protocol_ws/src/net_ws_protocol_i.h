...
struct net_ws_protocol {
    ...
    net_ws_endpoint_on_state_change_fun_t m_endpoint_on_state_change;
    net_ws_endpoint_on_text_msg_fun_t m_endpoint_on_text_msg;
    net_ws_endpoint_on_bin_msg_fun_t m_endpoint_on_bin_msg;
};
