...
static int net_ws_protocol_init(net_protocol_t protocol);
static void net_ws_protocol_fini(net_protocol_t protocol);
    ...
    net_ws_endpoint_fini_fun_t endpoint_fini)
{
    ...
    net_ws_protocol_t ws_protocol = net_protocol_data(protocol);
