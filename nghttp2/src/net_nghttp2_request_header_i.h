...
#include "net_nghttp2_request_header.h"
#include "net_nghttp2_request_i.h"

struct net_nghttp2_request_header {
    net_nghttp2_request_t m_request;
    TAILQ_ENTRY(net_nghttp2_request_header) m_next;
    uint16_t m_index;
    char * m_name;
    char * m_value;
    char m_buf[128];
...
net_nghttp2_request_header_t net_nghttp2_request_header_create(net_nghttp2_request_t request, uint16_t index, const char * name, size_t name_len);
...
net_nghttp2_request_header_t net_nghttp2_request_header_find_by_index(net_nghttp2_request_t request, uint16_t index);
