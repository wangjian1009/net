...
#include "net_http2_svr_request_header.h"
#include "net_http2_svr_request_i.h"

struct net_http2_svr_request_header {
    net_http2_svr_request_t m_request;
    TAILQ_ENTRY(net_http2_svr_request_header) m_next;
    uint16_t m_index;
    char * m_name;
    char * m_value;
    char m_buf[128];
...
net_http2_svr_request_header_t net_http2_svr_request_header_create(net_http2_svr_request_t request, uint16_t index, const char * name, size_t name_len);
...
net_http2_svr_request_header_t net_http2_svr_request_header_find_by_index(net_http2_svr_request_t request, uint16_t index);
