...
typedef struct net_trans_task_ds * net_trans_task_ds_t;
...
typedef net_trans_task_read_op_result_t
(*net_trans_task_read_op_t)(void * ctx, void * ds_ctx, void * o_data, uint32_t * o_data_sz);
